========================================================================
    スタティック ライブラリ: ShowRegistryStaticLibrary プロジェクトの概要
========================================================================

この ShowRegistryStaticLibrary ライブラリ プロジェクトは、AppWizard により作成されました。

このファイルには、ShowRegistryStaticLibrary アプリケーションを構成する各ファイルの内容の概要が含まれています。


ShowRegistryStaticLibrary.vcxproj
...
ShowRegistryStaticLibrary.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、ShowRegistryStaticLibrary.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。
